...
private:
	string cmnd;
public:
	treem(string m, string ht, string gt, date ns, int s, string cm) : DocGia(m, ht, ht, ns, s, cm)
	{
...
public:
	nguoilon(string m, string ht, string gt, date ns, int s, string cm) : DocGia(m, ht, ht, ns, s, cm)
	{
