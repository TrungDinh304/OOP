...
ostream& NhanVien::write_binary_file(ostream& out)
{
	out.write(maNV, daima);
	out.write(hoten, daiten);
	out.write((char*)(&ngaysinh), sizeof(ngaysinh));
	out.write((char*)(&gioitinh), sizeof(gioitinh));
	out.write(diachi, daidiachi);
	out.write((char*)&luong, sizeof(luong));
	return out;
}

istream& NhanVien::read_binary_file(istream& in)
{
	in.read(maNV, daima);
	in.read(hoten, daiten);
	in.read((char*)(&ngaysinh), sizeof(ngaysinh));
	in.read((char*)(&gioitinh), sizeof(gioitinh));
	in.read(diachi, daidiachi);
	in.read((char*)&luong, sizeof(luong));
	return in;
}
